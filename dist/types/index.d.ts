...
export type Middleware<T = unknown> = (ctx: InteractionContext<T>, next: () => Promise<void>) => Promise<void>;
export type InteractionHandler<T = unknown> = (ctx: InteractionContext<T>) => Promise<void>;
/**
 * Handler for buttons
 */
 ...
 */
export declare enum CooldownScope {
    USER = "user",
    GUILD = "guild",
    CHANNEL = "channel",
    GLOBAL = "global"
